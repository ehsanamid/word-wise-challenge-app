...
// Save practice score
export const savePracticeScore = async (userId: number, exampleId: number, score: number): Promise<boolean> => {
  try {
...
export const getNextPracticeExample = async (userId: number, difficulty: string): Promise<any> => {
  try {
